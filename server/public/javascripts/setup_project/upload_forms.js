...
;( function( $, window, document, undefined )
{
	...
	$( '.box' ).each( function()
	{
		var $form		 = $( this ),
			...
			$fileType = $form.attr("data-file-type"),
			$fileTypeStr = $form.attr("data-file-type-str"),
			$fileTypeExtension = $form.attr("data-file-type-extension")
		...
		function validateFile(file) {
			...
			if(!(a && b)) {
				...
				if(!b) { errMsg = "File must be a " + $fileTypeStr + " file (" + $fileTypeExtension + ")" }
