...
You may now successfully open `tagging.html` in your browser. At this stage, only the latest version of Google Chrome is supported, though Firefox will still work up until the point you need to merge all the data together.
...
Once the program has finished, you can find your merged file inside the `annotated_data/merged_data` folder. The format of the file is, for example,
