          ...
          {this.props.user && (
            <div className="dropdown-menu">
              ...
              <ul className="dropdown-menu-items">
                <li>
                  <Link to={"" + BASE_URL + "projects"}>Projects list</Link>
                </li>
                <li>
                  <Link to={"" + BASE_URL + "projects/new"}>New project</Link>
                </li>
              </ul>
            </div>
          )}
        ...
        <div className="navbar-right">
          {this.props.user && (
            <div
              className={
                ...
                (outstandingInvitationNum === 0 ? " inactive" : "")
              }
              id="invitations-menu"
            >
              <button id="invitations-button">
                <i className="fa fa-envelope"></i>
                {outstandingInvitationNum > 0 && (
                  <span className="invites-count" id="invites-count">
                    {outstandingInvitationNum}
                  </span>
                )}
              </button>
                  ...
                  {invitations.map((invite, index) => (
                    <li key={index}>
                      <span className="invite">
                        <span className="link">
                          {invite.inviting_user_username}
                        </span>{" "}
                        has invited you to annotate{" "}
                        <span className="link">{invite.project_name}</span>.
                        {!invite.accepted &&
                          !invite.declined &&
                          !invite.pending && (
                            <div className="invite-form">
                              <button
                                className="accept"
                                onClick={() =>
                                  this.props.acceptInvitation(index)
                                }
                              >
                                Accept
                              </button>
                              <button
                                className="decline"
                                onClick={() =>
                                  this.props.declineInvitation(index)
                                }
                              >
                                Decline
                              </button>
                        ...
                        {invite.accepted && (
                          <div className="invite-form-accepted">
                            <span>
                              <i className="fa fa-check"></i>&nbsp;Invitation
                              accepted!{" "}
                              <Link
                                to={
                                  "" +
                        ...
                        {invite.declined && (
                          <div className="invite-form-declined">
                            <span>
                              <i className="fa fa-close"></i>&nbsp;Invitation
                              declined.
                            </span>
                          </div>
                        )}
          ...
          {!this.props.user && (
            <div className="dropdown-menu log-in">
              <button>
                Not logged in&nbsp;&nbsp;
                <i className="fa fa-xs fa-chevron-down"></i>
              </button>
              <ul className="dropdown-menu-items">
                <li>
                ...
                <li>
                  <Link to={"" + BASE_URL + "register"}>Register</Link>
                </li>
              </ul>
            </div>
          )}
